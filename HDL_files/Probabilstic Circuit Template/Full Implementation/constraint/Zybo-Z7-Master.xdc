...
set_property -dict {PACKAGE_PIN P15 IOSTANDARD LVCMOS33} [get_ports clamp_EN]
...
set_property -dict {PACKAGE_PIN W15 IOSTANDARD LVCMOS33} [get_ports {out[1]}]
set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports {out[2]}]
set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports {out[3]}]
set_property -dict {PACKAGE_PIN W14 IOSTANDARD LVCMOS33} [get_ports {out[4]}]
set_property -dict {PACKAGE_PIN Y14 IOSTANDARD LVCMOS33} [get_ports {out[5]}]
set_property -dict {PACKAGE_PIN T12 IOSTANDARD LVCMOS33} [get_ports {out[6]}]
set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports {out[7]}]


##Pmod Header JD
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports {clk_delay[0]}]
set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports {clk_delay[1]}]
#set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33     } [get_ports { clk_delay[2] }]; #IO_L6P_T0_34 Sch=jd_p[2]
...
##Pmod Header JE
set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports {clamp[0]}]
set_property -dict {PACKAGE_PIN W16 IOSTANDARD LVCMOS33} [get_ports {clamp[1]}]
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33} [get_ports {clamp[2]}]
set_property -dict {PACKAGE_PIN H15 IOSTANDARD LVCMOS33} [get_ports {clamp[3]}]
set_property -dict {PACKAGE_PIN V13 IOSTANDARD LVCMOS33} [get_ports {clamp[4]}]
set_property -dict {PACKAGE_PIN U17 IOSTANDARD LVCMOS33} [get_ports {clamp[5]}]
set_property -dict {PACKAGE_PIN T17 IOSTANDARD LVCMOS33} [get_ports {clamp[6]}]
set_property -dict {PACKAGE_PIN Y17 IOSTANDARD LVCMOS33} [get_ports {clamp[7]}]
...
set_property MARK_DEBUG true [get_nets {ila_hist_data[15]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[20]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[21]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[26]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[27]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[31]}]
set_property MARK_DEBUG true [get_nets {ila_hist_sel[1]}]
set_property MARK_DEBUG true [get_nets {ila_hist_sel[5]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[17]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[0]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[7]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[9]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[11]}]
set_property MARK_DEBUG true [get_nets {ila_hist_sel[6]}]
set_property MARK_DEBUG true [get_nets {ila_hist_sel[7]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[12]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[13]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[28]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[16]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[22]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[23]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[19]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[4]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[5]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[10]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[18]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[24]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[30]}]
set_property MARK_DEBUG true [get_nets {ila_hist_sel[0]}]
set_property MARK_DEBUG true [get_nets {ila_hist_sel[4]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[2]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[1]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[3]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[6]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[8]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[14]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[25]}]
set_property MARK_DEBUG true [get_nets {ila_hist_data[29]}]
set_property MARK_DEBUG true [get_nets {ila_hist_sel[2]}]
set_property MARK_DEBUG true [get_nets {ila_hist_sel[3]}]
...
connect_debug_port u_ila_0/probe0 [get_nets [list {ila_hist_sel[0]} {ila_hist_sel[1]} {ila_hist_sel[2]} {ila_hist_sel[3]} {ila_hist_sel[4]} {ila_hist_sel[5]} {ila_hist_sel[6]} {ila_hist_sel[7]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 64 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {ila_hist_data[0]} {ila_hist_data[1]} {ila_hist_data[2]} {ila_hist_data[3]} {ila_hist_data[4]} {ila_hist_data[5]} {ila_hist_data[6]} {ila_hist_data[7]} {ila_hist_data[8]} {ila_hist_data[9]} {ila_hist_data[10]} {ila_hist_data[11]} {ila_hist_data[12]} {ila_hist_data[13]} {ila_hist_data[14]} {ila_hist_data[15]} {ila_hist_data[16]} {ila_hist_data[17]} {ila_hist_data[18]} {ila_hist_data[19]} {ila_hist_data[20]} {ila_hist_data[21]} {ila_hist_data[22]} {ila_hist_data[23]} {ila_hist_data[24]} {ila_hist_data[25]} {ila_hist_data[26]} {ila_hist_data[27]} {ila_hist_data[28]} {ila_hist_data[29]} {ila_hist_data[30]} {ila_hist_data[31]} {ila_hist_data[32]} {ila_hist_data[33]} {ila_hist_data[34]} {ila_hist_data[35]} {ila_hist_data[36]} {ila_hist_data[37]} {ila_hist_data[38]} {ila_hist_data[39]} {ila_hist_data[40]} {ila_hist_data[41]} {ila_hist_data[42]} {ila_hist_data[43]} {ila_hist_data[44]} {ila_hist_data[45]} {ila_hist_data[46]} {ila_hist_data[47]} {ila_hist_data[48]} {ila_hist_data[49]} {ila_hist_data[50]} {ila_hist_data[51]} {ila_hist_data[52]} {ila_hist_data[53]} {ila_hist_data[54]} {ila_hist_data[55]} {ila_hist_data[56]} {ila_hist_data[57]} {ila_hist_data[58]} {ila_hist_data[59]} {ila_hist_data[60]} {ila_hist_data[61]} {ila_hist_data[62]} {ila_hist_data[63]}]]
