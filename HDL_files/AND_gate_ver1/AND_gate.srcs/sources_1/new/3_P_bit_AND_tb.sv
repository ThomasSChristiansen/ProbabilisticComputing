module P_bit_AND_tb;
    ...
    // Outputs
    logic AND_out [0:2];                            // States of the 3 P-bits
    ...
    initial begin
        file = $fopen("AND_all_states.csv", "w");  // Open or create the file for writing
    ...
    initial begin
        ...
        forever begin
            ...
            if (file) begin
                $fwrite(file,"%t,%b,%f,%f,%f\n", $time, {AND_out[0], AND_out[1],AND_out[2]}, bias[0],bias[1],bias[2]);  // Write time and P_bit_out value to CSV file
            end
        end
    end
    ...
    final begin
        if (file) begin
            ...
            $display("Data written to AND_all_states.csv");
        end
    end
endmodule
