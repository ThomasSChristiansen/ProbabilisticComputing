...
##Pmod Header JC
set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33} [get_ports {m[0]}]
set_property -dict {PACKAGE_PIN W15 IOSTANDARD LVCMOS33} [get_ports {m[1]}]
set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports {m[2]}]
set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports clk_out]
set_property -dict {PACKAGE_PIN W14 IOSTANDARD LVCMOS33} [get_ports {active_P_bit[0]}]
set_property -dict {PACKAGE_PIN Y14 IOSTANDARD LVCMOS33} [get_ports {active_P_bit[1]}]
set_property -dict {PACKAGE_PIN T12 IOSTANDARD LVCMOS33} [get_ports {active_P_bit[2]}]
...
set_property MARK_DEBUG true [get_nets {P_bit_instances[0].p_bit_inst_n_0}]
set_property MARK_DEBUG true [get_nets {P_bit_instances[1].p_bit_inst_n_0}]
set_property MARK_DEBUG true [get_nets {P_bit_instances[2].p_bit_inst_n_0}]
