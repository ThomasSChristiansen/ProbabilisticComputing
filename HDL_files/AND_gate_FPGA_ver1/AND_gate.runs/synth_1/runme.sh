...
HD_PWD='C:/Users/thoma/Desktop/Vivado/AND_gate_FPGA_ver1/AND_gate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log P_bit_AND.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source P_bit_AND.tcl
