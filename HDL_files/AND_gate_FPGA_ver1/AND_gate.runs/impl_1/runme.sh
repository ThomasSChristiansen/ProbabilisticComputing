...
HD_PWD='C:/Users/thoma/Desktop/Vivado/AND_gate_FPGA_ver1/AND_gate.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log P_bit_AND.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source P_bit_AND.tcl -notrace
