...
HD_PWD='C:/Users/thoma/Desktop/Vivado/4bit_multiplier_ver2/4bit_multiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log probabilistic_circuit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source probabilistic_circuit.tcl -notrace
