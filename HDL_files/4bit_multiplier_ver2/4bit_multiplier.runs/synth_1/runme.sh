...
HD_PWD='C:/Users/thoma/Desktop/Vivado/4bit_multiplier_ver2/4bit_multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log probabilistic_circuit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source probabilistic_circuit.tcl
