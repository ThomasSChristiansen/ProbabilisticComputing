...
def CircuitSynth(verilog_filename, CircuitName,write_coe=False,PathToStart_Bat="C:/Users/thoma/Desktop/oss-cad-suite/oss-cad-suite/start.bat",extended=False):
    ...
    CS.generate_mem_files(J_total, h_total, CircuitName,write_coe=write_coe,extended=extended)
